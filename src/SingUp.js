    ...
    render() {
      return (
        ...
        <form onSubmit={this.handleSubmit}>
            ...
            <label>Adress Email :<input type="email" name="email"/></label>
            <label>Mot de passe :<input type="password" name="password"/></label>
            <label>Vérification de votre mot de passe :<input type="password" name="passwordVerif"/></label>
            Information :
            <RadioGroup onChange={ this.onChange } horizontal>
                <RadioButton value="man">M.</RadioButton>
                <RadioButton value="woman">Mm.</RadioButton>
                <RadioButton value="other">Autre</RadioButton>
            </RadioGroup>
            <label>Nom :<input type="text" name="name" /></label>
            <label>Prénom :<input type="text" name="subname" /></label>
            <label>date de naissance<input type="date" name="age"/></label>
            Adress:
            <label>Nom de l'adress :<input type="text" name="adress"/></label>
            <label>code postal :<input type="text" name="postalCode"/></label>
            <label>Ville :<input type="text" name="cytie"/></label>
